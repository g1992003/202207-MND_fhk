...
if (!isset($id) || !is_numeric($id)) {
	...
	$page_name = "category.php?p=album";

	$sql = "SELECT c_title_1,[album].c_id FROM [album] INNER JOIN [a_category] ON[a_category].c_id = [album].c_id  WHERE a_id = :id";
...
<body data-color="grey" class="flat">
	<div id="wrapper">
		...
		$title = html_decode("《" . $row[0] . "》相簿管理");
		$db_name = "album";
		$id_name = "a_id";
		$title_name_1 = "a_title_1";
