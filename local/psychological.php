...
<div class="title title-group layout">
  <h1 class="title-title-box layout"><pre class="title-title"><span class="tw">心理測驗</span>
          ...
          <div class="psychological-section2__flex-item">
            <div class="psychological-section2__group layout1">
              <px-posize x="1fr 99.9% 1fr" y="0fr minmax(0px, 713fr) 0fr" absolute="true"
                ><div
                  class="psychological-section2__block1"
                  style="--src:url(../images/assets/0fbeb2100ccec76a2c38cf86cb232ef3.png)"
                ></div
              ></px-posize>
              <div class="psychological-section2__flex layout1">
                <div class="psychological-section2__group layout">
                  <img
                    src="dist/images/assets/d466861ac8a3b8f83bdd5d9ac4045a5c.png"
                    alt=""
                    class="psychological-section2__block3 layout"
                  />
                </div>
...
Contact</pre
                ...
                <div class="psychological-section2__flex-item">
                  <div class="psychological-section2__mail layout">Psychological@test.com</div>
                </div>
                <a href="mailto:Psychological@test.com" class="psychological-section2__block2 layout">
