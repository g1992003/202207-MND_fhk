...
<div class="title title-group layout">
  <h1 class="title-title-box layout"><pre class="title-title"><span class="tw">相片剪影</span>
<span class="en">PHOTO</span>
      ...
      <div class="military-2-photoList layout">
        <div class="military-2-flex layout">
          <a href="photo.php" class="military-2-flex-item">
...
and Electronic Force Command</span></pre>
          ...
          <a href="photo.php" class="military-2-flex-item1">
...
Communication Wing</span></pre>
          ...
          <div class="military-2-flex-spacer"></div>
          <a href="photo.php" class="military-2-flex-item2">
...
Command Cyber Warfare Wing</span></pre>
          ...
          <a href="photo.php" class="military-2-flex-item3">
...
Operation Center</span></pre>
          ...
          <div class="military-2-flex-spacer"></div>
          <a href="photo.php" class="military-2-flex-item4">
